...
class AllCategories : Fragment(R.layout.fragment_all_categories) {
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            myData.add(AllCatData(R.drawable.appleorchard,"Apple orchard\ndevelopment"))
            myData.add(AllCatData(R.drawable.appliance_repair,"Appliance repair\n& service"))
            myData.add(AllCatData(R.drawable.architect,"Architect"))
            myData.add(AllCatData(R.drawable.cleaning_pest,"Cleaning\nPest Control"))
            myData.add(AllCatData(R.drawable.electrician_plug,"Electrician"))
            myData.add(AllCatData(R.drawable.home_paints,"Home Paints\n& cladding"))
            myData.add(AllCatData(R.drawable.interior_design,"Interior design"))
            myData.add(AllCatData(R.drawable.landscape_g,"Landscape\n& gardening"))
            myData.add(AllCatData(R.drawable.khatamband,"Khatamband"))
            myData.add(AllCatData(R.drawable.mens_salon,"Men’s salon\nand massage"))
            myData.add(AllCatData(R.drawable.plumbers,"Plumbers"))
            myData.add(AllCatData(R.drawable.wedding_services,"Wedding\nservices"))
            myData.add(AllCatData(R.drawable.wazwan,"Wazwan"))
            myData.add(AllCatData(R.drawable.women_salon,"Women’s salon\nand spa"))
           // allCategoriesRecyclerview.setItemViewCacheSize(myData.size)
            val adapter= AllCategoriesAdapter(myData)
